...
class ExceptionMapper {
  ...
  static AppFailure mapException(Object error, [StackTrace? stackTrace]) =>
      switch (error) {
        ...
        _ => UnexpectedFailure(error.toString(), stackTrace: stackTrace),
      };
  ...
  static AppFailure _mapStatusCode(
    ...
    return switch (statusCode) {
      ...
      403 => ForbiddenFailure(message ?? 'Forbidden', stackTrace: stackTrace),
      404 => NotFoundFailure(message ?? 'Not found', stackTrace: stackTrace),
      409 => ConflictFailure(message ?? 'Conflict', stackTrace: stackTrace),
      ...
      _ => NetworkFailure(message ?? 'Request failed', stackTrace: stackTrace),
    };
  }
