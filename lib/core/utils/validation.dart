...
final class Invalid<T> extends ValidationResult<T> {
  ...
  factory Invalid.single(String field, String message) => Invalid({
    field: [message],
  });
...
abstract final class TypedValidators {
  ...
  static Validator<String> email({String field = 'email', String? message}) =>
      (value) {
  ...
  static Validator<String> phone({String field = 'phone', String? message}) =>
      (value) {
  ...
  static Validator<String> url({String field = 'url', String? message}) =>
      (value) {
  ...
  static Validator<num> range(
    ...
    if (value < min || value > max) {
      return Invalid.single(field, message ?? 'Must be between $min and $max');
    }
    return Valid(value);
  };

  /// Validates that a value is not null.
  static Validator<T?> notNull<T>({String field = 'value', String? message}) =>
      (value) {
        if (value == null) {
